...
function GMG_subduction_2D_with_coords(
    ...
    Phases = zeros(Int64, nx_points, 1, ny_points) .+ 1
    ...
    add_box!(
        ...
        Grid2D;
        xlim = (-250.0, 250.0),
        zlim = (0.0, air_thickness),
        Origin = nothing, StrikeAngle = 0, DipAngle = 0,
        phase = LithosphericPhases(Layers = [], Phases = [4]),
    )
