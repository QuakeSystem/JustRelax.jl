...
@parallel_indices (i, j) function compute_∇V_strain_rate_RP!(
        εxx::AbstractArray{T, 2}, εyy, εxy, Vx, Vy, RP, P, P0, Q, ηb,
        _di_vertex, _di_vx, _di_vy, rheology, phase_ratio, ΔT, melt_fraction, dt,
        do_strain_rate, mask_vbox_c,
    ) where {T}
